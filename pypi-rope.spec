...
Source0  : https://files.pythonhosted.org/packages/74/3a/85e60d154f26ecdc1d47a63ac58bd9f32a5a9f3f771f6672197f02a00ade/rope-1.14.0.tar.gz
...
%prep
%setup -q -n rope-1.14.0
cd %{_builddir}/rope-1.14.0
pushd ..
cp -a rope-1.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752502451
