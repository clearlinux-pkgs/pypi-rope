...
Version  : 1.0.0
Release  : 44
URL      : https://files.pythonhosted.org/packages/ac/35/57eba304251572ec782c31e604a756d3db98e2d75ffee148688f42ed744c/rope-1.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/ac/35/57eba304251572ec782c31e604a756d3db98e2d75ffee148688f42ed744c/rope-1.0.0.tar.gz
...
%prep
%setup -q -n rope-1.0.0
cd %{_builddir}/rope-1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649430043
...
cp %{_builddir}/rope-1.0.0/COPYING %{buildroot}/usr/share/package-licenses/pypi-rope/a8a12e6867d7ee39c21d9b11a984066099b6fb6b
