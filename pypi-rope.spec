...
Version  : 1.4.0
Release  : 48
URL      : https://files.pythonhosted.org/packages/4a/87/cfc4cd0a8f8a2a8b6ae019bd7e10749287f44c84a94f9b663dc98e17b7de/rope-1.4.0.tar.gz
...
BuildRequires : pypi(pytoolconfig)
...
%prep
%setup -q -n rope-1.4.0
cd %{_builddir}/rope-1.4.0
pushd ..
cp -a rope-1.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666804803
