...
Source0  : https://files.pythonhosted.org/packages/7d/d7/f9ccefaf56089a7aa0a1d2b4082389d7855fdeaece2dd85fcecdce95aafc/rope-0.23.0.tar.gz
...
%prep
%setup -q -n rope-0.23.0
cd %{_builddir}/rope-0.23.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645977201
...
cp %{_builddir}/rope-0.23.0/COPYING %{buildroot}/usr/share/package-licenses/pypi-rope/a8a12e6867d7ee39c21d9b11a984066099b6fb6b
